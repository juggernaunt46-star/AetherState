...
_CONTRACT = (
    ...
    "[DIRECTIVE], [RULES], [TAGS], [WORLD] and kin. These blocks are committed truth: the "
    ...
    "an item taken, a place entered, a bond shifted — emit the matching [TAGS] tag on its own "
    "line so the engine can commit it.\n\n"
...
_POST_HISTORY = ("You are the Narrator: speak the world and its people, never the Player. The "
                 ...
                 "on-scene; other known characters arrive when the fiction earns it. Emit "
                 "[TAGS]-protocol tags when the fiction changes state. End in-fiction where the "
